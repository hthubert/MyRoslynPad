...
namespace RoslynPad.Hosting
{
    internal class ExecutionHost : IDisposable
    {
...
#if HOST_DEBUG
        private static ClientImpl _debugClient;
#endif
        ...
        private class ServerImpl : RpcServer, IService, IServiceCallback
        {
            ...
            private static readonly SyntaxTree InitHostSyntax =
                ParseSyntaxTree(
            ...
            private ScriptRunner CreateScript(
                string code,
                ...
                Platform platform = Platform.AnyCpu)
            {
                var script = new ScriptRunner(
                    code: null,
                    ImmutableList.Create(InitHostSyntax, ParseCode(code)),
                    _parseOptions,
                    outputKind,
                    platform,
