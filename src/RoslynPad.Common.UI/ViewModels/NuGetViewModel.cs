...
#pragma warning restore CS8618 // Non-nullable field is uninitialized.
        ...
        {
            LibraryRange GetLibraryRange()
            {
                return new LibraryRange("Microsoft.NETCore.App",
                    new VersionRange(restoreParameters.FrameworkVersion != null
                        ? new NuGetVersion(restoreParameters.FrameworkVersion)
                        : new NuGetVersion(restoreParameters.TargetFramework.Version)),
            ...
            if (restoreParameters.TargetFramework.Framework == ".NETCoreApp") {
                targetFramework.Dependencies.Add(GetLibraryDependency());
            }
