...
#pragma warning restore CS8618 // Non-nullable field is uninitialized.
        ...
        {
            ImmutableArray<string> GetReferences(IEnumerable<string> references_, Roslyn.RoslynHost host_)
            {
                return GetReferencePaths(host_.DefaultReferences).Concat(references_).ToImmutableArray();
            }
