...
namespace RoslynPad.Roslyn
{
    public class RoslynHostReferences
    {
        ...
        public RoslynHostReferences With(
            ...
            IEnumerable<Type> typeNamespaceImports = null)
        {
        ...
        public ImmutableArray<MetadataReference> GetReferences(Func<string, DocumentationProvider> documentationProviderFactory = null) =>
            _references.Concat(
                _referenceLocations.Select(c => MetadataReference.CreateFromFile(
                    c.Key, documentation: documentationProviderFactory?.Invoke(c.Key))))
                .ToImmutableArray();
